...
ActiveRecord::Schema[8.1].define(version: 2026_02_04_000004) do
# Could not dump table "bot_activity_logs" because of following StandardError
...
#   Unknown type '' for column 'created_by_bot_id'


# Could not dump table "votes" because of following StandardError
#   Unknown type '' for column 'bot_id'
  ...
  add_foreign_key "spaces", "bots", column: "created_by_bot_id"
  add_foreign_key "spaces", "profiles", column: "created_by_id"
  add_foreign_key "votes", "bots"
